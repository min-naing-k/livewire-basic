  ...
  <form wire:submit.prevent="postComment" action="#" method="POST" class="w-1/2 my-12">
    ...
    <div class="flex">
      ...
      <div class="ml-4 flex-1">
        <textarea wire:model.defer="content" name="comment" id="comment" rows="4" placeholder="Type your comment here..."
          class="form-textarea form-control border rounded-md shadow w-full px-4 py-2"></textarea>
